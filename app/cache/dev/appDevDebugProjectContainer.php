...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'kernel.listener.exceptionlistener' => 'getKernel_Listener_ExceptionlistenerService',
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.exception', array(0 => 'kernel.listener.exceptionlistener', 1 => 'onKernelException'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => '127.0.0.1', 'port' => 5432, 'dbname' => 'webinars', 'user' => 'webdev', 'password' => 'webdev', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/ChernovDA/WebinarsBundle/Entity'))), 'ChernovDA\\WebinarsBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('ChernovDAWebinarsBundle' => 'ChernovDA\\WebinarsBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_70566d94b8d9f512c52d0f6c9359ad576166cbfa7e1ec15113cf84db7fb5bcf4');
    ...
    /**
     * Gets the 'kernel.listener.exceptionlistener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ChernovDA\EventListener\ExceptionListener A ChernovDA\EventListener\ExceptionListener instance.
     */
    protected function getKernel_Listener_ExceptionlistenerService()
    {
        return $this->services['kernel.listener.exceptionlistener'] = new \ChernovDA\EventListener\ExceptionListener();
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('autosender@it-pole.com');
        $a->setPassword('13zEJQKrpp');
        $a->setAuthMode(NULL);

        $this->services['swiftmailer.mailer.default.transport.real'] = $instance = new \Swift_Transport_EsmtpTransport(new \Swift_Transport_StreamBuffer(new \Swift_StreamFilters_StringReplacementFilterFactory()), array(0 => $a), $this->get('swiftmailer.mailer.default.transport.eventdispatcher'));

        $instance->setHost('smtp.majordomo.ru');
        $instance->setPort(25);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/ChernovDA/TimeManagerBundle/Resources/views'), 'ChernovDATimeManager');
        $instance->addPath(($this->targetDirs[3].'/src/ChernovDA/WebinarsBundle/Resources/views'), 'ChernovDAWebinars');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('qwertyuiop');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('560be66337c7a6.39013764')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ChernovDATimeManagerBundle' => 'ChernovDA\\TimeManagerBundle\\ChernovDATimeManagerBundle',
                'ChernovDAWebinarsBundle' => 'ChernovDA\\WebinarsBundle\\ChernovDAWebinarsBundle',
            ...
            'database_port' => 5432,
            'database_name' => 'webinars',
            'database_user' => 'webdev',
            'database_password' => 'webdev',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'smtp.majordomo.ru',
            'mailer_user' => 'autosender@it-pole.com',
            'mailer_password' => '13zEJQKrpp',
            'mailer_port' => 25,
            'secret' => 'qwertyuiop',
            'locale' => 'en',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'smtp.majordomo.ru',
            'swiftmailer.mailer.default.transport.smtp.username' => 'autosender@it-pole.com',
            'swiftmailer.mailer.default.transport.smtp.password' => '13zEJQKrpp',
